...
CREATE TABLE IF NOT EXISTS `fecha_tarifa_por_experiencia` (
  ...
  `empleado_id_empleado` INT NOT NULL,
  `fecha_desde` DATE NULL,
  PRIMARY KEY (`tarifa_por_experiencia_id_tarifa_por_experiencia`, `empleado_id_empleado`),
...
INSERT INTO `ciudad` (`id_ciudad`, `nombre`) VALUES (2, 'Cordoba');
...
INSERT INTO `rol` (`id_rol`, `nombre_rol`) VALUES (4, 'Cobrador');
...
START TRANSACTION;
USE `sueldo`;
INSERT INTO `empleado` (`id_empleado`, `num_pass`, `nombre`, `telefono`, `direccion_id_direccion`, `rol_id_rol`) VALUES (1, '2325325', 'Goga Andrey', '1166994323', 1, 2);
...
INSERT INTO `empleado` (`id_empleado`, `num_pass`, `nombre`, `telefono`, `direccion_id_direccion`, `rol_id_rol`) VALUES (3, '1435245', 'Mijael Shumajer', '1166923759', 2, 1);
...
INSERT INTO `empleado` (`id_empleado`, `num_pass`, `nombre`, `telefono`, `direccion_id_direccion`, `rol_id_rol`) VALUES (5, '245245', 'Pasha Volya', '79148778766', 1, 2);
...
START TRANSACTION;
USE `sueldo`;
INSERT INTO `turno_trabajo` (`id_turno_trabajo`, `empleado_id_empleado`, `caja_id_caja`, `fecha_hora_inicio`, `fecha_hora_cierra`) VALUES (1, 1, 1, '2024-11-01 09:20:04', '2024-11-01 19:00:04');
INSERT INTO `turno_trabajo` (`id_turno_trabajo`, `empleado_id_empleado`, `caja_id_caja`, `fecha_hora_inicio`, `fecha_hora_cierra`) VALUES (2, 1, 1, '2024-11-02 09:10:04', '2024-11-02 19:10:04');
...
START TRANSACTION;
USE `sueldo`;
INSERT INTO `nomina_sueldo` (`id_nomina_sueldos`, `empleado_id_empleado`, `periodo`) VALUES (1, 1, '2024-10-01');
INSERT INTO `nomina_sueldo` (`id_nomina_sueldos`, `empleado_id_empleado`, `periodo`) VALUES (2, 1, '2024-11-01');
...
START TRANSACTION;
USE `sueldo`;
INSERT INTO `tarifa_individual` (`id_tarifa_individual`, `tarifa_por_hora`, `porcentaje_de_ventas`) VALUES (1, 100, 5);
INSERT INTO `tarifa_individual` (`id_tarifa_individual`, `tarifa_por_hora`, `porcentaje_de_ventas`) VALUES (2, 200, 5);
...
START TRANSACTION;
USE `sueldo`;
INSERT INTO `servicio_prod` (`id_servicio_o_prod`, `nombre`, `precio`) VALUES (1, 'copia', 10);
...
START TRANSACTION;
USE `sueldo`;
INSERT INTO `venta` (`movimiento_id_movimiento`, `cliente_id_cliente`) VALUES (1, 2);
INSERT INTO `venta` (`movimiento_id_movimiento`, `cliente_id_cliente`) VALUES (2, 3);
...
INSERT INTO `tarifa_por_experiencia` (`id_tarifa_por_experiencia`, `cantidad_horas`, `tarifa_por_hora`, `porcentaje_de_ventas`) VALUES (2, 180, 120, 7);
INSERT INTO `tarifa_por_experiencia` (`id_tarifa_por_experiencia`, `cantidad_horas`, `tarifa_por_hora`, `porcentaje_de_ventas`) VALUES (3, 360, 150, 10);
